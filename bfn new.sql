...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2017 at 08:16 PM
...
CREATE TABLE `product_limit` (
  ...
  `product_limit_product_id` int(11) NOT NULL,
...
INSERT INTO `product_limit` (`product_limit_id`, `product_limit_shop_id`, `product_limit_product_id`, `product_limit_max`) VALUES
(1, 1, 1, 0),
(2, 2, 2, 0),
(3, 2, 3, 0);
...
(2, '8850999320001', 'in', 400, '2014-09-24', '22:41:18', 1, 2),
...
(16, 'EX001', 'in', 10, '2017-02-24', '20:05:29', 1);
...
--
ALTER TABLE `product_limit`
  MODIFY `product_limit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
